...
if { $list_projs eq "" } {
   create_project project_1 myproj -part xcve2802-vsvh1760-2MP-e-S -force
   set_property BOARD_PART xilinx.com:vek280:part0:1.2 [current_project]
}

# Register local IP repository (hw_discovery, uuid_rom, cmd_queue)
set_property ip_repo_paths [file normalize [file join $script_folder iprepo]] [current_project]
...
proc create_root_design { parentCell } {
  ...
  set LPD_AXI_NOC_0_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 LPD_AXI_NOC_0_0 ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {64} \
   CONFIG.DATA_WIDTH {128} \
   CONFIG.FREQ_HZ {799992004} \
   CONFIG.HAS_REGION {0} \
  ...
  set PMC_NOC_AXI_0_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 PMC_NOC_AXI_0_0 ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {64} \
   CONFIG.DATA_WIDTH {128} \
  ...
  set CPM_PCIE_NOC_0_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 CPM_PCIE_NOC_0_0 ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {64} \
   CONFIG.DATA_WIDTH {128} \
   CONFIG.HAS_REGION {0} \
  ...
  set CPM_PCIE_NOC_1_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 CPM_PCIE_NOC_1_0 ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {64} \
   CONFIG.DATA_WIDTH {128} \
   CONFIG.HAS_REGION {0} \
  ...
  set lpd_axi_noc_clk_0 [ create_bd_port -dir O -type clk lpd_axi_noc_clk_0 ]
  set pmc_axi_noc_axi0_clk_0 [ create_bd_port -dir O -type clk pmc_axi_noc_axi0_clk_0 ]
  set noc_pmc_axi_axi0_clk_0 [ create_bd_port -dir O -type clk noc_pmc_axi_axi0_clk_0 ]
  set noc_cpm_pcie_axi0_clk_0 [ create_bd_port -dir O -type clk noc_cpm_pcie_axi0_clk_0 ]
  set cpm_pcie_noc_axi0_clk_0 [ create_bd_port -dir O -type clk cpm_pcie_noc_axi0_clk_0 ]
  set cpm_pcie_noc_axi1_clk_0 [ create_bd_port -dir O -type clk cpm_pcie_noc_axi1_clk_0 ]
...
31}}} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S00_AXI_1_1 [get_bd_intf_ports S00_AXI_1] [get_bd_intf_pins base_logic/s_axi_pcie_mgmt_slr0]
  ...
  connect_bd_intf_net -intf_net cips_CPM_PCIE_NOC_0 [get_bd_intf_ports CPM_PCIE_NOC_0_0] [get_bd_intf_pins cips/CPM_PCIE_NOC_0]
  connect_bd_intf_net -intf_net cips_CPM_PCIE_NOC_1 [get_bd_intf_ports CPM_PCIE_NOC_1_0] [get_bd_intf_pins cips/CPM_PCIE_NOC_1]
  connect_bd_intf_net -intf_net cips_LPD_AXI_NOC_0 [get_bd_intf_ports LPD_AXI_NOC_0_0] [get_bd_intf_pins cips/LPD_AXI_NOC_0]
  connect_bd_intf_net -intf_net cips_M_AXI_LPD [get_bd_intf_pins cips/M_AXI_LPD] [get_bd_intf_pins base_logic/s_axi_rpu]
  connect_bd_intf_net -intf_net cips_PCIE1_GT [get_bd_intf_ports PCIE1_GT_0] [get_bd_intf_pins cips/PCIE1_GT]
  connect_bd_intf_net -intf_net cips_PMC_NOC_AXI_0 [get_bd_intf_ports PMC_NOC_AXI_0_0] [get_bd_intf_pins cips/PMC_NOC_AXI_0]
  ...
  [get_bd_ports pmc_axi_noc_axi0_clk_0]
  ...
  [get_bd_ports peripheral_aresetn_0] \
